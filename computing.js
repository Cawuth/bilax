...
function aggiungiColonna(){
    ...
    temp=setInner(temp);
    document.getElementById('E.A1').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.A1-"+actualYear+"\" onkeyup=\"calculateEA("+actualYear+"),calculateE("+actualYear+"),calculateML("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+"),calculateEBITDA("+actualYear+"),calculateExB("+actualYear+"),calculateROS("+actualYear+"),calculateTRN("+actualYear+"),calculateIIC("+actualYear+"),calculateGCM("+actualYear+"),calculateCDC("+actualYear+"),calculateRM("+actualYear+")\"> </td>";

    //riga 251
    temp=document.getElementById('E.A2').innerHTML;
    temp=setInner(temp);
    document.getElementById('E.A2').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.A2-"+actualYear+"\" onkeyup=\"calculateEA("+actualYear+"),calculateE("+actualYear+"),calculateML("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+"),calculateEBITDA("+actualYear+"),calculateExB("+actualYear+")\"> </td>";

    //riga 252
    temp=document.getElementById('E.A3').innerHTML;
    temp=setInner(temp);
    document.getElementById('E.A3').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.A3-"+actualYear+"\" onkeyup=\"calculateEA("+actualYear+"),calculateE("+actualYear+"),calculateML("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+"),calculateEBITDA("+actualYear+"),calculateExB("+actualYear+")\"> </td>";

    //riga 253
    temp=document.getElementById('E.A4').innerHTML;
    temp=setInner(temp);
    document.getElementById('E.A4').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.A4-"+actualYear+"\" onkeyup=\"calculateEA("+actualYear+"),calculateE("+actualYear+"),calculateML("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+"),calculateEBITDA("+actualYear+"),calculateExB("+actualYear+")\"> </td>";

    //riga 254
    temp=document.getElementById('E.A5').innerHTML;
    temp=setInner(temp);
    document.getElementById('E.A5').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.A5-"+actualYear+"\" onkeyup=\"calculateEA("+actualYear+"),calculateE("+actualYear+"),calculateML("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+"),calculateEBITDA("+actualYear+"),calculateExB("+actualYear+")\"> </td>";

    //riga 255
    temp=document.getElementById('E.A51').innerHTML;
    temp=setInner(temp);
    document.getElementById('E.A51').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.A51-"+actualYear+"\" onkeyup=\"calculateEA5("+actualYear+"),calculateEA("+actualYear+"),calculateE("+actualYear+"),calculateML("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+"),calculateEBITDA("+actualYear+"),calculateExB("+actualYear+")\"> </td>";

    //riga 256
    temp=document.getElementById('E.A52').innerHTML;
    temp=setInner(temp);
    document.getElementById('E.A52').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.A52-"+actualYear+"\" onkeyup=\"calculateEA5("+actualYear+"),calculateEA("+actualYear+"),calculateE("+actualYear+"),calculateML("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+"),calculateEBITDA("+actualYear+"),calculateExB("+actualYear+")\"> </td>";

    //riga 257
    temp=document.getElementById('E.B').innerHTML;
    temp=setInner(temp);
    document.getElementById('E.B').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.B-"+actualYear+"\" onkeyup=\"calculateExB("+actualYear+"),calculateE("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+")\"> </td>";
    ...
    temp=setInner(temp);
    document.getElementById('E.B2').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.B2-"+actualYear+"\" onkeyup=\"calculateEB("+actualYear+"),calculateEBITDA("+actualYear+"),calculateExB("+actualYear+"),calculateE("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+"),calculateIPF("+actualYear+"),calculateCDC("+actualYear+")\"> </td>";

    //riga 261
    temp=document.getElementById('E.B3').innerHTML;
    temp=setInner(temp);
    document.getElementById('E.B3').innerHTML=temp+"<td><input type=\"text\" value=\"0\" id=\"E.B3-"+actualYear+"\" onkeyup=\"calculateEB("+actualYear+"),calculateEBITDA("+actualYear+"),calculateExB("+actualYear+"),calculateE("+actualYear+"),calculateEF("+actualYear+"),calculateEF2("+actualYear+"),calculateEH("+actualYear+"),calculateIPF("+actualYear+"),calculateCDC("+actualYear+")\"> </td>";
